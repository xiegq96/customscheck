...
package cn.bobo.fast.utils;

import cn.bobo.fast.entity.ColumnEntity;
import cn.bobo.fast.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "cn.bobo.fast" : mainPath;
